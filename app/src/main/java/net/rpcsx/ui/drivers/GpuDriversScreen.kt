...
import net.rpcsx.utils.DriversFetcher.FetchResultOutput
                ...
                items(drivers.entries.toList()) { (file, metadata) ->
                    DriverItem(
                        ...
                        onSelect = {
                            ...
                            RPCSX.instance.settingsSet("Video@@Vulkan@@Custom Driver@@Path", "\"" + path + "\"")
                            RPCSX.instance.settingsSet("Video@@Vulkan@@Custom Driver@@Internal Data Directory", "\"" + context.filesDir + "\"")
                        },
